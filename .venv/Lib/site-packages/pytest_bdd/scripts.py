...
def migrate_tests(args):
    """Migrate outdated practice to the most recent form."""
    path = args.path
...
def migrate_tests_in_file(file_path):
    """Migrate all bdd-based practice in the given test file."""
    try:
...
def main():
    ...
    parser_migrate.add_argument(
        "path",
        metavar="PATH",
        help="Migrate outdated practice to the most recent form",
    )
