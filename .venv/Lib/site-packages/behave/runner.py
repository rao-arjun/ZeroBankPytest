...
class Context(object):
    """Hold contextual information during the running of practice.

    This object is a place to store information related to the practice you're
    running. You may add arbitrary attributes to it of whatever value you need.

    During the running of your practice the object will have additional layers of
